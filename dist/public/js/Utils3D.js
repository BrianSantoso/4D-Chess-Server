...
function debugSphere(x = 0, y = 0, z = 0, color = 'red') {
    // if (typeof x != "number") {
    // 	y = x.y
    // 	z = x.z
    // 	x = x.x
...
exports.debugSphere = debugSphere;
...
function checkerboard(dim, squareSize, y = 0, w = 0) {
...
function checkerboard4D(dim, squareSize, deltaY, deltaW) {
    const [_x, _y, _z, _w] = dim;
...
exports.checkerboard4D = checkerboard4D;
;
