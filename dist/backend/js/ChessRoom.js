...
const PlayerData_js_1 = tslib_1.__importDefault(require("../../public/js/PlayerData.js"));
const ServerGameManager_1 = tslib_1.__importDefault(require("./ServerGameManager"));
...
// - - RoomData
// - - - ChessRoom
class ChessRoom extends colyseus_1.Room {
    // When room is initialized
    onCreate(options) {
        this._chatMsg = this._chatMsg.bind(this);
        this._sessionIdToUser = new Map();
        this._gameManager = new ServerGameManager_1.default(); // The gameManager originally used to create this game
    ...
    onAuth(client, options, request) {
        ...
        let decoded = jsonwebtoken_1.default.verify(options.authToken, process.env.JWT_SECRET);
        if (!decoded) {
            throw new ServerError(400, "Bad authToken");
        }
        return {
            playerAuthed: User_model_js_1.default.findById(decoded._id)
                .catch(err => {
    ...
    _addUser(client, dangerousBackendUserData) {
        let user = PlayerData_js_1.default.User(dangerousBackendUserData);
...
*/
exports.default = ChessRoom;
//# sourceMappingURL=ChessRoom.js.map