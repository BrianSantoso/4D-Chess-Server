...
class App extends Component {
	...
	render() {
		let embed = this.state.focus === 'uninitialized' ? '' : <Embed ref={this.embed} gameManager={this.gameManager} focus={this.state.focus} onMount={() => {}}></Embed>
		return (
			<Router history={history}>
				...
				{this.state.alert}
				<Route path="/home">
					<Home onMount={() => {}} onUnmount={() => {}}></Home>
				</Route>
				<Route path="/play">
					<Play onMount={this.onMaximize} onUnmount={this.onMinimize}></Play>
				</Route>
				{embed}
				<Route path="/login">
