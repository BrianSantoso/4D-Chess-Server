...
import { Tab, ListGroup, Container, Row, Col, Media } from 'react-bootstrap'
...
function GameSelect({handleSubmit=()=>{}}) {
    ...
    let [modifier, setModifier] = useState(DEFAULT_MODIFIER)
    let [opponent, setOpponent] = useState(DEFAULT_OPPONENT)
